...
static const wchar_t *const ui_strings[][3] = {
    ...
    { L"Reading CPU temperature needs administrator privileges. Restart elevated now?\n\n"
      L"If you say no, the program stays open without administrator privileges, and "
      L"Automatic mode will keep High Speed by default.",
      ...
      L"如果选择否，程序将继续以非管理员权限运行，自动模式将默认保持高转速。" },
